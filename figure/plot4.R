...
with(elecData, {
  ...
  plot(elecData$dateTime, elecData$Voltage, xlab="dateTime", ylab="Voltage", type = "l")
  {
  ...
  plot(elecData$dateTime, elecData$Global_reactive_power, xlab="dateTime", ylab="Global_reactive_power", type = "l")
})
